...
1. Sie können Ihre Push-Benachrichtigung als mehrsprachigen Versand konfigurieren, um Nachrichten basierend auf der bevorzugten Sprache eines Profils zu senden. [Weitere Informationen](../msg/multilingual.md).
