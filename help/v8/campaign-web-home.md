...
>[!TAB Version März 2026]

Die Version März ist live. Neue Funktionen und Verbesserungen sind jetzt in der Campaign Web-Benutzeroberfläche verfügbar. Zu den Highlights gehören:

* **Schemaerstellung (GA)** – Erstellen und verwalten Sie Schemata direkt in der Campaign Web-Benutzeroberfläche.
* **Designs in E-Mail-Designer (LA)** – Wenden Sie wiederverwendbare Design-Stile und Variablen an, um den E-Mail-Inhalt konsistent mit Ihrer Marke zu halten.
* **Workflow-Verbesserungen** – Die Aktivitäten **Automatischer Versand** und **Start** sind jetzt verfügbar und **Joins** unterstützen jetzt die Option „ODER“. Sie können Ihren Workflows jetzt auch mehrere Verzweigungen hinzufügen.
...
>[!TAB erzeugen von Inhalt]

✨ Tauchen Sie in ein interaktives Erlebnis mit unserer Live-Vorschau der Funktion [Inhalt erzeugen](../v8/content/generative-gs.md) ein, die es Ihnen ermöglicht, die Funktionen aus erster Hand zu erkunden und deren Möglichkeiten vollständig zu verstehen.
