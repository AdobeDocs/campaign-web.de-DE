...
Der Zugriff auf Berichte erfolgt in jeder Kampagne und jedem Versand durch Klicken auf **Berichte**. Ein Popup-Fenster wird angezeigt, das Sie darüber informiert, dass Sie auf die Seite **Dynamischer Bericht** auf einem neuen Browser-Tab weitergeleitet werden.
...
* **Vorlagen** können geändert werden, indem sie mit der Option **Speichern unter** (**Projekt > Speichern unter**) in der Vorlage kopiert werden.
