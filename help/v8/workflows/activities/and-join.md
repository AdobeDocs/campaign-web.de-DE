...
Die Aktivität **Und-Verknüpfung** ist eine Aktivität zur **Fluss-Steuerung**. Sie ermöglicht es, die Ausführung verschiedener Workflow-Zweige zu synchronisieren.
...
1. Fügen Sie die Aktivität **Und-Verknüpfung** zu einem der Zweige hinzu.
...
Das folgende Beispiel zeigt zwei Workflow-Zweige mit einem E-Mail- und SMS-Versand. Die Und-Verknüpfung wird ausgelöst, wenn beide eingehenden Transitionen aktiviert sind. Die Push-Benachrichtigungen werden erst dann gesendet, wenn beide Sendungen abgeschlossen sind.
