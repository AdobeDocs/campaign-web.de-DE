...
Nachdem Ihr Workflow erstellt wurde, können Sie mit der Orchestrierung der verschiedenen Aufgaben beginnen, die er ausführen wird, und zwar in einer dedizierten visuellen Arbeitsfläche. [Erfahren Sie, wie Sie Workflow-Aktivitäten koordinieren.](build-workflow.md)
