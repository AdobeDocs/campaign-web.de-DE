...
1. Definieren Sie die Regel für den Filter. Zum Beispiel Profile, die älter als 30 sind.
   ...
   ![Filterregel für Profile, die älter als 30 Tage sind](assets/filter-30-plus.png){zoomable="yes"}
...
1. Navigieren Sie zum vordefinierten Filter, der zum Erstellen der Zielgruppe verwendet werden soll, wählen Sie ihn aus und bestätigen Sie die Wahl.
   ...
   Sie können einen vorhandenen vordefinierten Filter auch mithilfe der Schaltfläche ![](../content/assets/do-not-localize/Smock_More_18_N.svg) bearbeiten oder löschen.
