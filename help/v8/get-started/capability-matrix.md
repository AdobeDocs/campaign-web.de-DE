...
Die Adobe Campaign Web-Benutzeroberfläche zeigt alle Datums- und Zeitwerte basierend auf der **lokalen Zeitzone des Webbrowsers der oder des Benutzenden** an. Dieses Verhalten kann zu Abweichungen führen, wenn Zeitstempel zwischen der Web-Benutzeroberfläche und der Client-Konsole verglichen werden.

Auf dieser [Seite](../administration/timezone-management.md) erfahren Sie mehr über die Unterschiede zwischen den Zeitzonen der **Web-Benutzeroberfläche**, der **Client-Konsole** und der **Workflow-Ausführung**.
