...
Welche Aktionen Ihnen für einen Ordner zur Verfügung stehen, hängt davon ab, welche Berechtigungen Ihnen dafür gewährt wurden. Je nach Ihren Berechtigungen wird das Dialogfeld **[!UICONTROL Ordnereinstellungen]** möglicherweise im **schreibgeschützten Modus** geöffnet und einige Aktionen oder Abschnitte sind vielleicht nicht verfügbar.

Wenden Sie sich an Ihre bzw. Ihren Admin, wenn Ihnen Berechtigungen für einen Ordner fehlen. In diesem [Abschnitt](permissions.md#folder-permissions) erfahren Sie, wie Ordnerberechtigungen verwaltet werden.

Spezifische Berechtigungen wie **[!UICONTROL Ordner einfügen]**, **[!UICONTROL Ordner bearbeiten]** und **[!UICONTROL Ordner löschen]** bestimmen auch, welche Ordneraktionen einer Benutzerin bzw. einem Benutzer zur Verfügung stehen. Weitere Informationen finden Sie in der [Dokumentation zu Campaign v8](https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/permissions/manage-permissions#use-named-rights){target="_blank"}.
