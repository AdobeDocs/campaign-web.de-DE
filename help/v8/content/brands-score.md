...
# Auswerten Ihrer Inhalte {#brands-score}
...
* **Markenausrichtung**: Prüfen und verwalten Sie Inhalte, die Ihren Markenrichtlinien entsprechen. Dadurch wird Konsistenz in Ton, Messaging und visueller Identität in Ihren E-Mail-Kampagnen sichergestellt.
* **Qualitätsprüfung**: Validieren Sie Ihre Inhalte vor der Veröffentlichung, um hohe Standards und Markenintegrität zu gewährleisten.
...
1. Erstellen Sie Ihren [E-Mail-Versand](../email/create-email.md).

1. Öffnen Sie das Menü **[!UICONTROL Markenausrichtung]** im E-Mail-Designer.

   ![](assets/quality-score-1.png)

1. Klicken Sie auf **[!UICONTROL Wert auswerten]**, um sowohl die Markenausrichtung als auch die Inhaltsqualitätswerte zu generieren.

   ![](assets/quality-score-2.png)

1. Navigieren Sie zur Registerkarte **[!UICONTROL Gesamtqualität]**, um Erkenntnisse und Empfehlungen zur Inhaltsqualität zu erhalten.

   ![](assets/quality-score-3.png)

1. Klicken Sie auf das Symbol ![Vollbildsymbol für detaillierte Erkenntnisse](assets/do-not-localize/Smock_FullScreen_18_N.svg "Vollbild"), um eine detaillierte Ansicht Ihrer Qualitätsbewertung zu erhalten.
...
1. Wählen Sie ein markiertes Element aus, um spezifisches Feedback und umsetzbare Verbesserungsvorschläge anzuzeigen. Die Bewertungen basieren auf den folgenden Kategorien:
   ...
   * **[!UICONTROL CTA-Effektivität]**: Wertet aus, wie gut Ihr Handlungsaufruf Ihre Lesenden dazu motiviert, die gewünschte Aktion durchzuführen.
   * **[!UICONTROL Betreffzeile]**: Bewertet Klarheit, Relevanz und Aufmerksamkeit erregende Qualität, um E-Mail-Öffnungen zu fördern.
   * **[!UICONTROL Lesbarkeit]**: Misst, wie einfach und ansprechend Ihre Inhalte für Lesende sind.
   * **[!UICONTROL Spam-Prüfung]**: Identifiziert gängige Spam-Trigger, die die Zustellbarkeit beeinträchtigen können.
   * **[!UICONTROL Inhaltskohärenz]**: Stellt sicher, dass Ihre Inhalte reibungslos fließen und auf das Thema fokussiert bleiben.
...
1. Klicken Sie nach dem Vornehmen von Änderungen auf **[!UICONTROL Werte neu auswerten]**, um Ihre Qualitätsbewertung zu aktualisieren.
