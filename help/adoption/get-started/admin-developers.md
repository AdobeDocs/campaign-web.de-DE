...
* Die Komponenten und globale Architektur von Adobe Campaign werden auf [dieser Seite](https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/new/ac-components){target="_blank"} beschrieben.
...
In diesem Tutorial erfahren Sie mehr über die Benutzeroberfläche von Adobe Campaign v8 und darüber, wie Sie durch die Hauptfunktionen navigieren.
...
Beim Wechsel zu Campaign v8 werden auch die von Ihnen vorhandenen externen Campaign Standard-Konten berücksichtigt, die nun in der Client-Konsole verfügbar sind.

Erfahren Sie mehr über die [Konfiguration externer Konten](https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/config/configuration/external-accounts){target="_blank"}.
